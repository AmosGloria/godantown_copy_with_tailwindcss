...
const Faq = () => {
  return (
    <div className="flex flex-col items-start text-left mx-[6%] my-[2%] p-4 max-w-full overflow-x-auto mb-[5%] pb-[5%]">
      {/* Title Section */}
      <h1 className="text-[2.5rem] md:text-[3rem] font-bold mb-6 leading-none px-[4%]">
      ...
      <div className="flex flex-wrap justify-center gap-8 w-full md:w-max md:flex-nowrap overflow-x-auto p-4">
        ...
        {[
          ...
          },
          {
            ...
            answer:
              "When a virtual card is blocked, all functionalities are disabled. You can block your card as many times as needed within a day.",
          },
          {
            img: "/transactQuestion.png",
            question: "How can I transact with my virtual card?",
            answer:
              "All details—card name, card number, expiry date, and CVC number are provided on the card for your online transactions.",
          },
          {
            img: "/compatibilityQuestion.png",
            question: "Is the virtual card compatible with all devices?",
            answer:
              "Currently, the virtual card has been tested and is compatible with various Android and iOS devices.",
          },
          {
            img: "/internationalQuestion.png",
            question: "Can I use my virtual card for international transactions?",
            answer:
              "Yes, you can use your card for international transactions. Note that there are specific transaction fees and conversion fees applicable.",
          },
          {
            img: "/notificationsQuestions.png",
            question: "Will I receive notifications for my card transactions?",
            answer:
              "Yes, you will receive notifications via emails, transaction history logs, and push notifications for all transactions and card management activities.",
          },
        ].map((faq, index) => (
          <div
            key={index}
